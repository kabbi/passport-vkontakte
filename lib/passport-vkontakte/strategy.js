 ...
 *   - `apiLanguage`   the translation language of some VK API returned strings (en, ru, be)
...
function Strategy(options, verify) {
  ...
  this._apiLanguage = options.apiLanguage;
}
...
Strategy.prototype.userProfile = function(accessToken, done) {
  ...
  url += '?fields=' + fields.join(',') + '&v='+this._apiVersion;

  if (this._apiLanguage) {
    url += '&lang=' + this._apiLanguage;
  }
